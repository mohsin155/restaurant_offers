    ...
    <div class="maincontentinner">
        ...
        <div class="widget">
            ...
            <div class="widgetcontent">
                ...
                @endif
                <form class="stdform" action="{{isset($restaurant)?url('businesses/update-branch').'/'.$restaurant->user_id:url('businesses/register-branch')}}" enctype="multipart/form-data" method="post" />
                ...
                <p>
                    ...
                    <span class="field"><input type="password" name="password" class="input-xxlarge" value="" placeholder="Password" /></span>
                </p>
                <p>
                ...
                @if(isset($restaurant) && !empty($restaurant->gallery))
                <?php $loop = count($restaurant->gallery);?>
                ...
                <p class="stdformbutton">
                    <button class="btn btn-primary" type="submit">{{isset($restaurant)?'Update':'Register'}}</button>
                </p>
